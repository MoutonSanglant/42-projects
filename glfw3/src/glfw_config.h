...
#define _GLFW_BUILD_DLL 0
// Define this to 1 to use Vulkan loader linked statically into application
#define _GLFW_VULKAN_STATIC 0

// Define this to 1 to force use of high-performance GPU on hybrid systems
#define _GLFW_USE_HYBRID_HPG 0

// Define this to 1 if the Xxf86vm X11 extension is available
#define _GLFW_HAS_XF86VM 0

// Define this to 1 if glfwInit should change the current directory
#define _GLFW_USE_CHDIR 0
// Define this to 1 if glfwCreateWindow should populate the menu bar
#define _GLFW_USE_MENUBAR 0
