...
# define TERM_CURSOR_LEFT(put_fn) tputs(tgetstr("le", 0), 1, put_fn)
# define TERM_CURSOR_RIGHT(put_fn) tputs(tgetstr("nd", 0), 1, put_fn)
...
# define TERM_CLEAR_ALL(put_fn) tputs(tgetstr("cl", 0), 1, put_fn)
# define TERM_CLEAR_DOWN(put_fn) tputs(tgetstr("cd", 0), 1, put_fn)
